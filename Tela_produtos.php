<?php
$tipo = $_GET['searchTipo'];
$subTipo = $_GET['searchSubtipo'];
if ($subTipo == '*' && $tipo != '*' && $tipo != 'promocoes' ) {
    $queryM = " WHERE pro_tipo = '" . $tipo . "'";
} elseif ($tipo == 'promocoes' && $subTipo == '*') {
    $queryM  = " WHERE promocoes = 's'";
} elseif ($tipo == '*' && $subTipo == '*') {
    $queryM = "";
} else {
    $queryM  = " WHERE pro_tipo = '" . $tipo . "' AND pro_subtipo = '" . $subTipo . "'";
}
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Tela_produtos_CSS.css">
                        ...
                        <div class="main_menu menu_position">
                            <nav>
                                <ul>
                                        ...
                                        <ul class="sub_menu pages">
                                            ...
                                            while ($ln = mysqli_fetch_assoc($result_query)) {
                                                ...
                                                if ($subTipo == "*") {
                                                    ...
                                                    echo '<a href="Tela_produtos.php?searchTipo=' . $ln['pro_tipo'] . '&searchSubtipo=' . $ln['pro_subtipo'] . '">' . $ln['pro_tipo'] . '</a>';
                                                }
                                                echo '</li>';
                                            }
                                            ?>
                                    ...
                                    <li><a class="active" href="#">Seções<i class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu pages">
                                            <li>
                                                <?php
                                                echo '<li>';
                                                echo '<a href="Tela_produtos.php?searchTipo=' . $tipo . '&searchSubtipo=*">Todos</a>';
                                                echo '</li>';
                                                ?>
                                            </li>
                                            <?php
                                            ...
                                            $query = "SELECT pro_subtipo,pro_tipo, COUNT(pro_tipo) AS quantidade FROM produto WHERE pro_tipo='" . $tipo . "' GROUP BY pro_subtipo";

                                            $result_query = mysqli_query($conn, $query);
                                            while ($ln = mysqli_fetch_assoc($result_query)) {
                                                echo '<li>';
                                                echo '<a href="Tela_produtos.php?searchTipo=' . $ln['pro_tipo'] . '&searchSubtipo=' . $ln['pro_subtipo'] . '">' . $ln['pro_subtipo'] . '</a>';
                                                echo '</li>';
                                            }
                                            ?>
                                        </ul>
                        ...
                        <div class="breadcrumb_content">
                            <ul>
                                ...
                                if ($tipo == "*") {
                                    ...
                                    echo '<li><a href="Tela_produtos.php?searchTipo=' . $tipo . '&searchSubtipo=*">' . $tipo . '</li>';
                                }
                                ?>
                                <li>
                                    <?php
