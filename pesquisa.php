...
if (isset($_POST['search'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM produto WHERE pro_nome LIKE '%$searchq%' OR pro_tipo LIKE '%$searchq%'");
    $count = mysqli_num_rows($result);

    if ($count == 0) {
        $output = 'Não foi encontrado resultado';
    } else {
